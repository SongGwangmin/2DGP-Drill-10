...
# frame per sec는 frame per action * action per sec
time_per_action = 0.3
frames_per_action = 8
...
class Idle:
    ...
    def do(self):
        self.boy.frame = (FRAMES_PER_SEC * game_framework.frame_time + self.boy.frame) % 8
...
# frame per second와 delta t를 이용해 프레임 전환
